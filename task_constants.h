...
#define GRAPH_PRI		60			// priority of graphic_task
//-----------------------------------------------------
...
#define LAUNCHER_PRI	40			// priority of rocket_launcher_task
