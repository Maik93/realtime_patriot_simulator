...
#define MENU_TITLE_Y	MENU_BOX_Y1 + 5
...
#define MENU_CONTENT9_X	MENU_CONTENT8_X
#define MENU_CONTENT9_Y	MENU_CONTENT8_Y + 1.5 * CHAR_HEIGHT
//-----------------------------------------------------
#define MENU_DIVISOR_X1	WORLD_BOX_X1
#define MENU_DIVISOR_Y1	MENU_ERROR1_Y - 5
#define MENU_DIVISOR_X2	WORLD_BOX_X2
#define MENU_DIVISOR_Y2	MENU_ERROR1_Y - 5
//-----------------------------------------------------
#define MENU_ERROR2_X	MENU_BOX_X1 + MENU_BOX_WIDTH / 2
#define MENU_ERROR2_Y	MENU_BOX_Y2 - CHAR_HEIGHT - 5
